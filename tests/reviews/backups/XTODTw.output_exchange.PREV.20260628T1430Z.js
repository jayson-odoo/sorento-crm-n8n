...
function deriveRouting(out) {
  ...
  switch (domain) {
    case 'master_products':    return { suggested_team: 'purchasing',       suggested_agent: 'general_enquiries' };
    ...
    case 'order':              return { suggested_team: 'warehouse',        suggested_agent: 'order_enquiries' };
